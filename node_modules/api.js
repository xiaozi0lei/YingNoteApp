...
var Api = {
		...
		Notebook.getServerNotebookIdByNotebookId(note.NotebookId, function(serverNotebookId) {
			...
			try {
				needle.post(me.getUrl('note/addNote'), data, 
					{ca: crtKey, multipart: needMultiple},
					function(err, resp) {
						me.checkError(err, resp);
						if(err) {
							return callback(err);
	...
	updateNote: function(note, callback) {
		...
		Notebook.getServerNotebookIdByNotebookId(note.NotebookId, function(serverNotebookId) {
			...
			needle.post(me.getUrl('note/updateNote'), data, {ca: crtKey, multipart: needMultiple}, function(err, resp) {
	...
	post: function() {
		var me = this;
		var options = {ca: crtKey, headers: { 'X-Custom-Header': 'Bumbaway atuna' }};
	...
	uploadImage: function() {
		...
		needle.post('http://localhost/phpinfo.php', data, { ca: crtKey, multipart: true }, function(err, resp, body) {
